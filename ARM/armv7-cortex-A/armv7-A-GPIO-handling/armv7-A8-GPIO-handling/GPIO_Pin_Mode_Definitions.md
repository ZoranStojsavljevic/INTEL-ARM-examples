### GPIO Pin Mode Definitions (armv7 A8 Sitara am33xx silicon)
https://elixir.bootlin.com/linux/latest/source/include/dt-bindings/pinctrl/omap.h
```
...
#endif
```
https://elixir.bootlin.com/linux/latest/source/include/dt-bindings/pinctrl/am33xx.h
```
/* SPDX-License-Identifier: GPL-2.0 */
/*
